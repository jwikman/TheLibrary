...
You must first start with to build the app by calling `al_build`, and calling the `refreshXlf` tool to ensure the XLF files are up to date with the AL source code.
...
After translating, you can auto approve all suggested translations.
